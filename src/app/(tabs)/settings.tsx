...
export default function SettingsScreen() {
  ...
  const cardWidth = { flexBasis: isExpanded ? '47%' as const : '100%' as const, flexGrow: 1 };
  return <Screen title="Settings" description="Preferences are stored only on this device.">
    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: spacing.md }}>
      ...
      <View style={cardWidth}><Card><ListRow icon="troubleshoot" title="Diagnostics" description="Sanitized connection activity stored on this device." onPress={() => router.push('/diagnostics')} /></Card></View>
    </View>
  </Screen>;
}
