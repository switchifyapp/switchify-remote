...
import { ForwardingSurface } from '@/forwarding/ForwardingSurface';
...
export default function RemoteScreen() {
  ...
  return (
    <Screen title="Remote" description={`Connected to ${connection.desktop.displayName}`}>
      ...
      {preferences.surface === 'forwarding' ? <ForwardingSurface manager={manager} bridge={bridge} profile={connection.profile} desktopId={connection.desktop.desktopId} preferences={preferences} /> : null}
    </Screen>
  );
}
