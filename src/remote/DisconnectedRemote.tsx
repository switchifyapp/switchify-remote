...
export function DisconnectedRemote({ connection, selectedSurface, retry, choose, bottomAccessory }: { connection: DisconnectedState; selectedSurface: RemoteSurface; retry: () => void; choose: () => void; bottomAccessory?: ReactNode }) {
